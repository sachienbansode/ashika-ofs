 ...
 */
async function send({ to, subject, html, purpose, triggeredBy, ip, attachments }) {
  ...
  try {
    const mail = { from: fromLine(s), to, subject, html };
    // Only set when there is something to attach: some servers treat an empty
    // attachments array as a malformed multipart message.
